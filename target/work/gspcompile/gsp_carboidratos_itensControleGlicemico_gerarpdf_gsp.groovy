...
class gsp_carboidratos_itensControleGlicemico_gerarpdf_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('message','g',56,['code':("controle.list.label")],-1)
printHtmlPart(6)
invokeTag('message','g',57,['code':("headerimpressaocontamgem.message"),'args':([mes, ano, usuarioInstance.buscaNome(usuarioInstance)])],-1)
printHtmlPart(7)
invokeTag('message','g',63,['code':("controle.dia.label")],-1)
printHtmlPart(8)
invokeTag('message','g',64,['code':("controle.refeicao.label")],-1)
printHtmlPart(8)
invokeTag('message','g',65,['code':("controle.qtdinsulinelenta.label")],-1)
printHtmlPart(8)
invokeTag('message','g',66,['code':("controle.valorglicemiapre.label")],-1)
printHtmlPart(8)
invokeTag('message','g',67,['code':("controle.qtdinsulinarapidapre.label")],-1)
printHtmlPart(8)
invokeTag('message','g',68,['code':("controle.qtdcarboidrato.label")],-1)
printHtmlPart(8)
invokeTag('message','g',69,['code':("controle.valorglicemiapos.label")],-1)
printHtmlPart(8)
invokeTag('message','g',70,['code':("controle.qtdinsulinarapidapos.label")],-1)
printHtmlPart(8)
invokeTag('message','g',71,['code':("controle.observacao.label")],-1)
printHtmlPart(9)
...
printHtmlPart(11)
invokeTag('set','g',80,['var':("diaatual"),'value':(itensControleGlicemicoInstance.controleglicemico.dia)],-1)
printHtmlPart(12)
...
printHtmlPart(18)
invokeTag('set','g',102,['var':("diaanterior"),'value':(diaatual)],-1)
printHtmlPart(10)
j++
}
}
...
invokeTag('captureBody','sitemesh',110,['class':("bodyimpressao"),'onload':("window.print()")],1)
printHtmlPart(20)
}
...
public static final long LAST_MODIFIED = 1427572360000L
