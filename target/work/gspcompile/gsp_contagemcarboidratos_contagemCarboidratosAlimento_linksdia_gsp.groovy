...
class gsp_contagemcarboidratos_contagemCarboidratosAlimento_linksdia_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/contagemCarboidratosAlimento/_linksdia.gsp" }
public Object run() {
Writer out = getOut()
