...
printHtmlPart(32)
invokeTag('field','g',103,['min':("0"),'class':("qtd"),'size':("4"),'name':("qtdalimento"),'type':("number")],-1)
printHtmlPart(33)
invokeTag('textField','g',105,['id':("alimentoforalista"),'name':("alimentoforalista"),'class':("obs")],-1)
printHtmlPart(34)
invokeTag('field','g',107,['min':("0"),'id':("carboidratos"),'class':("qtd"),'size':("4"),'name':("qtdcarboidrato"),'type':("number")],-1)
printHtmlPart(35)
...
printHtmlPart(65)
invokeTag('field','g',231,['min':("0"),'value':(contagemCarboidratosAlimentoInstance.qtdalimento),'class':("qtd"),'size':("4"),'name':("qtdalimento"),'type':("number")],-1)
printHtmlPart(33)
...
printHtmlPart(34)
invokeTag('field','g',235,['min':("0"),'id':("carboidratos"),'value':(contagemCarboidratosAlimentoInstance.qtdcarboidrato),'class':("qtd"),'size':("4"),'name':("qtdcarboidrato"),'type':("number")],-1)
printHtmlPart(66)
if(true && (contagemCarboidratosAlimentoInstance.alimento)) {
printHtmlPart(67)
...
public static final long LAST_MODIFIED = 1427810339000L
