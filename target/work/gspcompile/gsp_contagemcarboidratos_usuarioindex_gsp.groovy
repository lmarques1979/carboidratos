...
class gsp_contagemcarboidratos_usuarioindex_gsp extends GroovyPage {
...
printHtmlPart(10)
invokeTag('sortableColumn','g',33,['property':("imagem"),'title':(message(code: 'usuario.imagem.label', default: 'Imagem'))],-1)
printHtmlPart(11)
loop:{
int i = 0
...
printHtmlPart(16)
invokeTag('paginate','g',56,['total':(usuarioInstanceCount ?: 0)],-1)
printHtmlPart(17)
})
...
public static final long LAST_MODIFIED = 1427390629000L
