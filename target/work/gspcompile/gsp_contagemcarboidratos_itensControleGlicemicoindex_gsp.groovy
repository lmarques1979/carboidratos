...
printHtmlPart(47)
invokeTag('select','g',160,['id':("refeicao"),'name':("refeicao.id"),'from':(carboidratos.Refeicao.refeicaoUsuario(usuarioInstance)),'value':(itensControleGlicemicoInstance.refeicao.id),'optionValue':("descricao"),'optionKey':("id")],-1)
printHtmlPart(48)
invokeTag('field','g',162,['class':("qtd"),'size':("4"),'name':("qtdinsulinelenta"),'type':("number"),'value':(itensControleGlicemicoInstance.qtdinsulinelenta)],-1)
printHtmlPart(49)
invokeTag('field','g',163,['class':("qtd"),'size':("4"),'name':("valorglicemiapre"),'type':("number"),'value':(itensControleGlicemicoInstance.valorglicemiapre)],-1)
printHtmlPart(49)
invokeTag('field','g',164,['class':("qtd"),'size':("4"),'name':("qtdinsulinarapidapre"),'type':("number"),'value':(itensControleGlicemicoInstance.qtdinsulinarapidapre)],-1)
printHtmlPart(49)
invokeTag('field','g',165,['class':("qtd"),'size':("4"),'name':("qtdcarboidrato"),'type':("number"),'value':(itensControleGlicemicoInstance.qtdcarboidrato)],-1)
printHtmlPart(49)
invokeTag('field','g',166,['class':("qtd"),'size':("4"),'name':("valorglicemiapos"),'type':("number"),'value':(itensControleGlicemicoInstance.valorglicemiapos)],-1)
printHtmlPart(49)
invokeTag('field','g',167,['class':("qtd"),'size':("4"),'name':("qtdinsulinarapidapos"),'type':("number"),'value':(itensControleGlicemicoInstance.qtdinsulinarapidapos)],-1)
printHtmlPart(49)
invokeTag('textField','g',168,['name':("observacao"),'class':("obs"),'value':(itensControleGlicemicoInstance.observacao)],-1)
printHtmlPart(50)
createTagBody(4, {->
invokeTag('image','asset',170,['class':("excluir"),'src':("skin/remove.png"),'title':(message(code:'remove.label'))],-1)
})
invokeTag('link','g',170,['onclick':("return confirm('${message(code: 'excluirrefeicao.confirm.message', default: 'Are you sure?')}');"),'id':(itensControleGlicemicoInstance.id),'action':("delete"),'controller':("ItensControleGlicemico")],4)
printHtmlPart(51)
invokeTag('set','g',173,['var':("diaanterior"),'value':(diaatual)],-1)
printHtmlPart(35)
j++
}
}
printHtmlPart(52)
invokeTag('actionSubmit','g',182,['class':("save"),'action':("update"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(53)
})
invokeTag('form','g',188,['class':("formtable"),'url':([resource:itensControleGlicemicoInstance, action:'update'])],2)
printHtmlPart(54)
invokeTag('paginate','g',191,['total':(controleGlicemicoInstanceCount ?: 0)],-1)
printHtmlPart(55)
})
...
public static final long LAST_MODIFIED = 1427583771000L
