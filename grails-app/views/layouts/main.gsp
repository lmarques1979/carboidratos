				...
				<ul>
					...
					<sec:ifLoggedIn>
						...
						<g:else>
							...
							<li><g:link class="${params.controller=='ContagemCarboidratosAlimentos' && params.action=='index'? 'active' : '' }" controller="ContagemCarboidratosAlimento" action="index"><g:message code="contagem.label"/></g:link></li>
